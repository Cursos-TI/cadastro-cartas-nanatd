...
// Nível mestre: Comparação de cartas e Super Poder
...
int main() { 
  ...
  SuperPoder1 = (densidadepopulacional1 + area1 + PibperCapita1 + (1.0f / densidadepopulacional1));
  
  densidadepopulacional2 = populaçao2 / area2;
  PibperCapita2 = (pib2 * 1000000000) / populaçao2;
  SuperPoder2 = (densidadepopulacional2 + area2 + PibperCapita2 + (1.0f / densidadepopulacional2));
